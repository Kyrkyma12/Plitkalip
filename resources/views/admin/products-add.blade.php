        ...
        <div class="main-content-wrap">
                ...
                <div class="wg-box">
                    ...
                    <div class="gap22 cols">
                        ...
                        <fieldset class="color">
                            <div class="body-title mb-10">{{__('messages.Color')}} <span class="tf-color-1">*</span>
                            </div>
                            <div class="select">
                        ...
                        <fieldset class="size">
                            <div class="body-title mb-10">{{__('messages.Size')}} <span class="tf-color-1">*</span>
                            </div>
                            <div class="select">
            ...
            <img src="images/upload/upload-1.png" alt="">
                    ...
                    <div class="cols gap22">
                        ...
                        <fieldset class="name">
                            <div class="body-title mb-10">Width <span class="tf-color-1">*</span>
                            </div>
                            <input class="mb-10" type="text" placeholder="Enter width" name="width" tabindex="0" value="{{ old('width') }}" aria-required="true" required="">
                        </fieldset>
                        @error('width') <span class="alert alert-danger text-center">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="cols gap22">
                        ...
                        <fieldset class="name">
                            <div class="body-title mb-10">Любимый товар</div>
                            <div class="select mb-10">
                        ...
                        <fieldset class="name">
                            <div class="body-title mb-10">Есть скидка</div>
                            <div class="select mb-10">
                                <select class="" name="is_on_sale">
                                    <option value="0">Нет</option>
                                    <option value="1">Да</option>
                                </select>
                            </div>
                        </fieldset>
                        @error('is_on_sale') <span class="alert alert-danger text-center">{{ $message }}</span> @enderror
